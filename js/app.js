(() => {
    ...
    function initSliders() {
        bildSliders();
        if (document.querySelector(".popup__slider")) new core(".popup__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".rune__slider")) new core(".rune__slider", {
            ...
            navigation: {
                prevEl: ".rune__button-prev",
                nextEl: ".rune__button-next"
            }
        });
    }
    ...
    function clickEvents(e) {
        if (e.target.closest(".rune-casting-btn")) {
            const castingMenu = document.querySelector(".menu__body");
            if (castingMenu) {
                castingMenu.classList.toggle("_active");
                castingMenu.querySelector(".menu__casting-menu").style.transition = "0.25s";
            }
        }
        if (e.target.closest(".menu__casting-close")) {
            const castingMenu = document.querySelector(".menu__body");
            if (castingMenu) castingMenu.classList.remove("_active");
        }
        if (!document.querySelector(".menu__body").contains(e.target)) {
            const castingMenu = document.querySelector(".menu__body");
            if (castingMenu) castingMenu.classList.remove("_active");
        }
    }
